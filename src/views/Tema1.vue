...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Por este motivo, debemos ubicarlos en diferentes categorías, las cuales abordaremos a continuación:
    ...
    p.mb-5 Ampliemos la información sobre las bases de datos y, para hacerlo, lo invitamos a ver el siguiente video:

    figure.mb-5
        .video
          iframe(width="560" height="315" src="https://www.youtube.com/embed/fkCvmC6Savc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
